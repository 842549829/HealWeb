...
import WriteBackup from './components/WriteBackup.vue'
import DetailBackup from './components/DetailBackup.vue'
...
const writeRef = ref<ComponentRef<typeof WriteBackup>>()
